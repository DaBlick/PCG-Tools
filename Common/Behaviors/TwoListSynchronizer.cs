...
namespace Common.Behaviors
{
    ...
    public class TwoListSynchronizer : IWeakEventListener
    {
        ...
        public void StartSynchronizing()
        {
            ...
            // (This is the case with a ListBox SelectedItems collection: only items from the ItemsSource 
            // can be included in SelectedItems)
        ...
        {
            return _masterList.Cast<object>().SequenceEqual(_targetList.Cast<object>().Select(
