...
namespace PcgTools.Model.Kross2Specific.Pcg
{
    ...
    /// 
    /// </summary>
    public class Kross2TrFileReader : PatchesFileReader
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public Kross2TrFileReader(IPcgMemory currentPcgMemory, byte[] content, 
        ...
        public override void ReadContent(Memory.FileType filetype, Models.EModelType modelType)
            // Continue parsing.
        {
            var memory = (Kross2PcgMemory) CurrentPcgMemory;
