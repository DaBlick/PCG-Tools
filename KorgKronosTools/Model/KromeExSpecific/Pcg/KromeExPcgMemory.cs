...
namespace PcgTools.Model.KromeExSpecific.Pcg
{
    ...
    /// 
    /// </summary>
    public class KromeExPcgMemory : MPcgMemory
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="fileName"></param>
        public KromeExPcgMemory(string fileName)
            : base(fileName, Models.EModelType.KromeEx)
        {
            CombiBanks = new KromeExCombiBanks(this);
            ProgramBanks = new KromeExProgramBanks(this);
            SetLists = null;
            WaveSequenceBanks = null;
            DrumKitBanks = new KromeExDrumKitBanks(this);
            DrumPatternBanks = new KromeExDrumPatternBanks(this);
            Global = new KromeExGlobal(this);
