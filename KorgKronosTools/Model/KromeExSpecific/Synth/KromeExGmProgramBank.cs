...
namespace PcgTools.Model.KromeExSpecific.Synth
{
    ...
    /// 
    /// </summary>
    public class KromeExGmProgramBank : ProgramBank
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public KromeExGmProgramBank(IProgramBanks programBanks, BankType.EType type, string id, int pcgId,
        ...
        {
            Add(new KromeExGmProgram(this, index, "GM" + (index + 1))); //FUTURE: Real name instead of GMn, use GmPrograms.cs
        }
