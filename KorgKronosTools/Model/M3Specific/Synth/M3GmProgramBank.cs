...
namespace PcgTools.Model.M3Specific.Synth
{
    public class M3GmProgramBank : ProgramBank
    {
        ...
        public M3GmProgramBank(IBanks programBanks, BankType.EType type, string id, int pcgId,
        ...
        {
            Add(new M3GmProgram(this, index, "GM" + (index + 1))); //FUTURE: Real name instead of GMn, use GmPrograms.cs
        }
