...
namespace PcgTools.Model.KromeSpecific.Synth
{
    ...
    /// 
    /// </summary>
    public class KromeGmProgramBank : ProgramBank
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public KromeGmProgramBank(IProgramBanks programBanks, BankType.EType type, string id, int pcgId,
        ...
        {
            Add(new KromeGmProgram(this, index, "GM" + (index + 1))); //FUTURE: Real name instead of GMn, use GmPrograms.cs
        }
