...
namespace PcgTools.Model.TritonLeSpecific.Synth
{
    ...
    /// 
    /// </summary>
    public class TritonLeGmProgramBank : ProgramBank
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public TritonLeGmProgramBank(IBanks programBanks, BankType.EType type, string id, int pcgId,
        ...
        {
            Add(new TritonLeGmProgram(this, index, "GM" + (index + 1))); //FUTURE: Real name instead of GMn
        }
